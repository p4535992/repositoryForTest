 ...
 String fc = "";
	...
	if (listaCategorie.contains("NearBusStops")){
		...
		String queryString = "PREFIX SiiMobility:<http://www.disit.dinfo.unifi.it/SiiMobility#> " + 
				...
				"	?bs geo:lat ?bslat . " + 
				"	 ?bs geo:long ?bslong . " + 
				"	?bs omgeo:nearby(" + latitudine + " " + longitudine + " \"0." + raggio + "km\") . " + 
	...
	String queryString = "PREFIX SiiMobility:<http://www.disit.dinfo.unifi.it/SiiMobility#> " + 
			...
			"	?entry omgeo:nearby(" + latitudine + " " + longitudine + " \"0." + raggio + "km\") . " + 
			"   } " + 
			"   UNION " + 
			"   { " + 
			"		?ser geo:lat ?elat . " + 
					" ?ser geo:long ?elong . " + 
					" ?ser omgeo:nearby(" + latitudine + " " + longitudine + " \"0." + raggio + "km\") . " + 
					//"FILTER NOT EXISTS {?ser SiiMobility:hasAccess ?entry .} " + 
					"   } " + 
				fc + 	
			"	} ";
