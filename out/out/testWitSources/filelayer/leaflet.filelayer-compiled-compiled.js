System.registerModule("../../../testWitSources/filelayer/leaflet.filelayer-compiled.js", [], function () {
  "use strict";

  var __moduleName = "../../../testWitSources/filelayer/leaflet.filelayer-compiled.js";
  System.registerModule("../../../testWitSources/filelayer/csv2geojson.js", [], function () {
    ...
    !(function (e) {
      if ("object" == (typeof exports === 'undefined' ? 'undefined' : $traceurRuntime.typeof(exports)) && "undefined" != typeof module) module.exports = e();else if ("function" == typeof define && define.amd) define([], e);else {
        var o;
      ...
      return (function e(t, n, r) {
        ...
        3: [function (require, module, exports) {
          ...
          function pair(x, dims) {
            ...
            if (one.dim) return swapdim(one.val, two.val, one.dim);else return [one.val, two.val];
          }
  ...
  System.registerModule("../../../testWitSources/filelayer/leaflet.filelayer.js", [], function () {
    ...
    var FileLoader = L.Class.extend({
      ...
      load: function (file) {
        var fileSize;
        if (typeof file == 'undefined') fileSize = 1024;else fileSize = (file.size / 1024).toFixed(4);
            ...
            if (obj === null || typeof obj === 'undefined' || id >= Object.keys(json).length - 1) {
              ...
              return {
                ...
                properties: {
                  id: id,
                  title: (function () {
                    for (var search = void 0, i = 0; search = titles[i++];) {
                  ...
                  popupContent: (function () {
                    ...
                    for (var title = void 0, i = 0; title = titles[i++];) {
                      try {
      ...
      _removeNullJson: function (json) {
        ...
        for (var k in json) {
          if (json[k] == null || typeof json[k] === 'undefined') isArray ? json.splice(k, 1) : delete json[k];else if ($traceurRuntime.typeof(json[k]) == "object") this._removeNullJson(json[k]);
        }
      },
      ...
      _gtfsToGeoJSON: function (content) {
        ...
        var lookup = {};
        var dintintShape = [];
        for (var item = void 0, i = 0; item = shapes[i++];) {
...
System.get("../../../testWitSources/filelayer/leaflet.filelayer-compiled.js" + '');
//# sourceMappingURL=leaflet.filelayer-compiled.js.map

//# sourceMappingURL=leaflet.filelayer-compiled-compiled.js.map