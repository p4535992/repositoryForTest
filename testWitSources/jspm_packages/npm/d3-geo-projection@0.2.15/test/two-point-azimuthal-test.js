...
suite.addBatch({"twoPointAzimuthal": {
    topic: load("two-point-azimuthal"),
    "default": {
      topic: function(geo) {
        return geo.twoPointAzimuthal();
      },
    ...
    "Honolulu, HI ↔ Washington, DC": {
      topic: function(geo) {
        return geo.twoPointAzimuthal().points([[-158, 21.5], [-77, 39]]);
      },
      "projections and inverse projections": function(twoPointAzimuthal) {
    ...
    "points ordering is respected": {
      "[[-30, 0], [30, 0]]": {
        topic: function(geo) {
          return geo.twoPointAzimuthal().points([[-30, 0], [30, 0]]);
        },
        "projections and inverse projections": function(twoPointAzimuthal) {
