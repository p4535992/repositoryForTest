...
var π = Math.PI;
suite.addBatch({"equirectangular": {"rotate": {
      "identity": {
        topic: function() {
      ...
      "[30, 0]": {
        ...
        "projections and inverse projections": function(projection) {
          ...
          assert.inDelta(projection([180, 0]), [-5 / 6 * π, 0], 1e-6);
      ...
      "[30, 30]": {
        ...
        "projections and inverse projections": function(projection) {
          ...
          assert.inDelta(projection([180, 0]), [-2.5535900500422257, 0.44783239692893245], 1e-6);
      ...
      "[30, 30, 30]": {
        ...
        "projections and inverse projections": function(projection) {
          ...
          assert.inDelta(projection([180, 0]), [-2.8605577520869800, 0.67513153293703170], 1e-6);
