...
(function(e) {
  if ("function" == typeof bootstrap)
    ...
    "undefined" != typeof window ? window.csv2geojson = e() : global.csv2geojson = e();
})(function() {
  var define,
      ses,
      bootstrap,
    ...
    3: [function(require, module, exports) {
      module.exports = function(x, dims) {
        ...
        if (!m)
          ...
          return (((m[1]) ? parseFloat(m[1]) : 0) + ((m[2] ? parseFloat(m[2]) / 60 : 0)) + ((m[3] ? parseFloat(m[3]) / 3600 : 0))) * ((m[4] && m[4] === 'S' || m[4] === 'W') ? -1 : 1);
      };
    }, {}],
