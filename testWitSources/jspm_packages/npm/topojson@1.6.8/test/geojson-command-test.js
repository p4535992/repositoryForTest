...
(function(process) {
  ...
  suite.addBatch({
    "Polygons": testConversion({polygon: "polygon-feature"}, "-- test/topojson/polygon.json"),
    "Non-quantized Polygons": testConversion({polygon: "polygon-feature"}, "-- test/topojson/polygon-no-quantization.json"),
    ...
    }, "--precision 2" + " -- test/topojson/polygon-mercator.json")
  });
