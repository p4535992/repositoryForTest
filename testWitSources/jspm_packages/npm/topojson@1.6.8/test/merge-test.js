    ...
    "stitches together two side-by-side polygons with holes": function() {
      var topology = topojson.topology({collection: {
          ...
          features: [{
            ...
            geometry: {
              type: "Polygon",
              coordinates: [[[3, 0], [3, 3], [6, 3], [6, 0], [3, 0]], [[4, 1], [5, 1], [5, 2], [4, 2], [4, 1]]]
            }
          }]
        }}, {quantization: 0});
      assert.deepEqual(topojson.merge(topology, topology.objects.collection.geometries), {
    ...
    "stitches together two horseshoe polygons, creating a hole": function() {
      var topology = topojson.topology({collection: {
          ...
          features: [{
            ...
            geometry: {
              type: "Polygon",
              coordinates: [[[0, 0], [0, 3], [2, 3], [2, 2], [1, 2], [1, 1], [2, 1], [2, 0], [0, 0]]]
            }
          }, {
            type: "Feature",
            geometry: {
              type: "Polygon",
              coordinates: [[[2, 0], [2, 1], [3, 1], [3, 2], [2, 2], [2, 3], [4, 3], [4, 0], [2, 0]]]
            }
          }]
        }}, {quantization: 0});
      assert.deepEqual(topojson.merge(topology, topology.objects.collection.geometries), {
    ...
    "stitches together two horseshoe polygons surrounding two other polygons": function() {
      var topology = topojson.topology({collection: {
          ...
          features: [{
            ...
            geometry: {
              type: "Polygon",
              coordinates: [[[2, 1], [2, 2], [3, 2], [3, 1], [2, 1]]]
            }
          }]
        }}, {quantization: 0});
      assert.deepEqual(topojson.merge(topology, topology.objects.collection.geometries), {
