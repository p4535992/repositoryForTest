...
suite.addBatch({"simplify": {
    "removes points with area below minimum area threshold": function() {
      var topology = simplify({
        ...
        objects: {},
        arcs: [[[0, 0], [10, 10], [0, 1], [1, -1], [-11, 0], [0, -10]]]
      }, {
        "minimum-area": 2,
        "coordinate-system": "cartesian"
      });
      assert.deepEqual(topology.arcs, [[[0, 0], [10, 10], [-10, 0], [0, -10]]]);
    },
    ...
    "assumes non-delta-encoded arcs for non-quantized topologies": function() {
      var topology = simplify({
        objects: {},
        arcs: [[[0, 0], [10, 10], [10, 11], [11, 10], [0, 10], [0, 0]]]
      }, {
        "minimum-area": 2,
        "coordinate-system": "cartesian"
      });
      assert.deepEqual(topology.arcs, [[[0, 0], [10, 10], [0, 10], [0, 0]]]);
    },
    "preserves degenerate arcs in non-quantized topologies": function() {
      ...
      assert.deepEqual(topology.arcs, [[[50, 50], [50, 50]]]);
    },
    "preserves degenerate arcs in quantized topologies": function() {
      ...
      assert.deepEqual(topology.arcs, [[[50, 50], [0, 0]]]);
    },
    "does not remove empty arcs": function() {
      var topology = simplify({
        ...
        arcs: [[[0, 0], [10, 0]], [[10, 0], [1, 1], [-1, -1]], [[10, 0], [0, 10]]]
      }, {
        "minimum-area": 1,
        "coordinate-system": "cartesian"
      });
      assert.deepEqual(topology.arcs, [[[0, 0], [10, 0]], [[10, 0], [0, 0]], [[10, 0], [0, 10]]]);
