...
suite.addBatch({"feature": {
    ...
    "Point is a valid geometry type": function() {
      ...
      assert.deepEqual(topojson.feature(t, t.objects.foo), {
        type: "Feature",
        properties: {},
        geometry: {
          type: "Point",
    ...
    "unknown geometry types are converted to null geometries": function() {
      ...
      assert.deepEqual(topojson.feature(topology, topology.objects.foo), {
        type: "Feature",
        id: "foo",
        properties: {},
        geometry: null
      });
      assert.deepEqual(topojson.feature(topology, topology.objects.bar), {
        type: "Feature",
        properties: {bar: 2},
        geometry: null
      });
      assert.deepEqual(topojson.feature(topology, topology.objects.baz), {
        type: "FeatureCollection",
        features: [{
          type: "Feature",
          id: "unknown",
