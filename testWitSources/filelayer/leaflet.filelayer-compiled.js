...
var FileLoader = L.Class.extend({
    ...
    _simplifyJson: function _simplifyJson(json) {
        ...
        for (var i = 0; i < Object.keys(json).length; i++) {
            ...
            try {
                var elements;
                if (Object.keys(obj).length > 1) elements = Object.keys(obj).toString().split(",");else elements = Object.keys(obj).toString();
    ...
    _removeNullJson: function _removeNullJson(json) {
        ...
        for (var k in json) {
            ...
            if (json[k] == null || typeof json[k] === 'undefined') isArray ? json.splice(k, 1) : delete json[k];else if (_typeof(json[k]) == "object") this._removeNullJson(json[k]);
        }
    },
...
//# sourceMappingURL=leaflet.filelayer-compiled.js.map